            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">{{trans('menu.attendences')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
@section('content')
    ...
    <div class="card">
        ...
        {!! Form::open(['id'=>'form_data','url'=>HostUrl('attendences/deleteMulti'),'method'=>'delete']) !!}
