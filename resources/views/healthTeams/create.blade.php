            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('healthTeams.index')}}"> {{trans('menu.healthTeams')}}
                            </a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">
                                @if(isset($healthTeam))   {{trans('form.update.healthTeam')}}  @else  {{trans('form.add.healthTeam')}}  @endif
...
@section('content')
    ...
    <div class="page-body">
        @if(isset($healthTeam))
            {!! Form::model($healthTeam, ['route' => ['healthTeams.update', $healthTeam->id], 'method' => 'put','class'=>'j-pro','id' => 'j-pro', 'files' => true]) !!}
        @else
            {!! Form::open(['role' => 'form', 'route' => 'healthTeams.store', 'class'=>'j-pro','id' => 'j-pro', 'method' => 'post', 'files' => true]) !!}
        @endif
        <div class="card">
            <div class="card-header">
                <h5> @if(isset($healthTeam))   {{trans('form.update.healthTeam')}}  {{$healthTeam->name}} @else {{trans('form.add.healthTeam')}}   @endif </h5>
            </div>
                    ...
                    <div class="j-forms">
                        <div class="content">
                            <div class="divider-text gap-top-20 gap-bottom-45">
                                <span>{{trans('form.info.healthTeam')}}</span>
                            </div>
                            <!-- start name email -->
                            <div class="j-row">
                                <div class="input">
                                    ...
                                    {!! Form::text('title', null, [ 'id' => 'title'  ,'placeholder'=>trans("form.healthTeam.title")]) !!}
                                    @error('title') <span
                            ...
                            <div class="j-row">
                                <div class="span6 unit">
                                    ...
                                    <div class="input">
                                        {!! Form::text('code',(isset($healthTeam))?$healthTeam->code: null  , [ 'id' => 'name'  ,'placeholder'=>trans("form.healthTeam.code")]) !!}
                                        @error('code') <span
                                            class="btn-block badge badge-danger">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="span6 unit">
                                    <label class="j-label">  {{trans('form.healthTeams.manager')}}</label>
                                    <div class="j-input">
                                        {!!Form ::select('manager_id', getAllManagers(),isset($healthTeam)?$healthTeam->manager_id:null,['class' => 'select2 form-control', 'id' => 'manager_id'])!!}
                                    </div>
                            ...
                            <div class="j-row">
                                <div class="col-sm-12 col-xl-8">
                                    <h4 class="sub-title">{{trans('form.healthTeam.healthTeam_ranage')}}</h4>
                                    <div class="input-daterange input-group" id="datepicker">
                                        {!! Form::text('start_date',  isset($healthTeam)?dateFormat($healthTeam->start_date):null, [ 'id' => '' ,'class'=>'input-sm form-control','placeholder'=>trans('form.healthTeam.start_date')]) !!}

                                        <span class="input-group-addon">to</span>
                                        {!! Form::text('end_date',  isset($healthTeam)?dateFormat($healthTeam->end_date):null, [ 'id' => '' ,'class'=>'input-sm form-control','placeholder'=>trans('form.healthTeam.end_date')]) !!}
                            ...
                            <div class="divider gap-bottom-25"></div>
                            <div class="j-unit">
                                <label class="j-label">Description {{trans('form.healthTeams.description')}}</label>
                                <div class="j-input">
                            ...
                            <div class="j-row">
                                <div class="col-xs-12 ">
                                    <a href="{{ route('healthTeams.index') }}" class="btn btn-warning ">
