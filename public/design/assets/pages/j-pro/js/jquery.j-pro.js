        ...
        sendFormDataAsync: function () {
            ...
            return $.ajax({
                ...
                success: function (data) {
                    config.afterSuccessSubmit(data);
        ...
        processingMultistepForm: function () {
            ...
            $nextBtn.on("click", function (e) {
                ...
                if (!self.errorExists) {
                    ...
                    $stepList.filter(".j-active-fieldset").removeClass("j-active-fieldset").next("fieldset").addClass("j-active-fieldset");

                    // Switch the "active" class to the next step
                    if ($stepTitleList.length) {
                        $stepTitleList.filter(".j-active-step").removeClass("j-active-step").addClass("j-passed-step").next(".j-step-title").addClass("j-active-step");
                    }
            ...
            $prevBtn.on("click", function (e) {
                ...
                $stepList.filter(".j-active-fieldset").removeClass("j-active-fieldset").prev("fieldset").addClass("j-active-fieldset");


                // Switch the "active" class to the next step
                if ($stepTitleList.length) {
                    $stepTitleList.filter(".j-active-step").removeClass("j-active-step").prev(".j-step-title").removeClass("j-passed-step").addClass("j-active-step");
                }
