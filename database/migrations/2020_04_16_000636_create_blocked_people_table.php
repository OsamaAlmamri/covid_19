    ...
    public function up()
    {
        Schema::create('blocked_people', function (Blueprint $table) {
           ...
           $table->enum('bp_type', ['track_owner', 'people'])->default('people');
            ...
            $table->foreign('last_zone_visit_id')->references('id')->on('zones')->onDelete('cascade')->onUpdate('cascade');
            $table->date('start_date_symptoms')->nullable();
            $table->boolean('sleeping')->default(false);
            $table->date('sleep_date')->nullable();
            $table->date('insulation_date')->nullable();
            ...
            $table->date('out_from_country_date')->nullable();
            $table->date('comming_to_yemen_date')->nullable();
            ...
            $table->enum('response_team_interventions', ['investigation', 'file_closed', 'case_was_lost', 'other', 'none'])->default('none');
