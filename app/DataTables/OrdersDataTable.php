...
class OrdersDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables($query)
            ->addIndexColumn()
            ->addColumn('manage', 'admin.orders.btn.manage')
            ->addColumn('manageDeleted', 'admin.orders.btn.manageDeleted')
            ->addColumn('image', 'admin.orders.btn.image')
            ->rawColumns([
                'manage',
                'manageDeleted',
                'image',
    ...
    public function query()
    {
        if ($this->type != "deleted")
            ...
            $data = DB::table('orders')
                ->leftJoin('admins', 'orders.deleted_by', '=', 'admins.id')
                ->select('orders.*', 'admins.name as deleted_by_name')
    ...
    {
        $btnAdd = [];
        if (Auth::user()->can('manage orders') != false) {
