                        ...
                        <div class="content">
                            ...
                            <div class="j-row">
                                ...
                                <div class="span6 unit">
                                    ...
                                    <div class="j-input">
                                        {!!Form ::select('work_team_id', getAllWorker(isset($user)?($user->work_team_id):0),isset($quarantine)?$quarantine->work_team_id:null,['class' => 'select2 form-control', 'id' => 'work_team_id'])!!}
                                    </div>
