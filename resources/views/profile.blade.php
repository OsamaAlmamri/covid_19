                        ...
                        <div class="content">
                            ...
                            <div class="j-row">
                                ...
                                <div class="form-group col-xs-12 mb-2">
                                    <input type="file" accept="image/*" name="avatar2"
...
@section('js')
    ...
    <!-- Custom js -->
    <script type="text/javascript" src="{{ HostUrl('design\assets\pages\j-pro\js\custom\booking.js')}}"></script>
    ...
    <script src="{{ asset('design/custom/js/jquery.easy-autocomplete.min.js') }}" type="text/javascript"></script>
