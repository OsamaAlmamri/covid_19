        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>{{trans('menu.'.$type.'_block_peoples')}}</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        {{--                        <li class="breadcrumb-item"><a href="#!">{{trans('menu.check_block_peoples')}}</a>--}}
                        <li class="breadcrumb-item"><a href="#!">{{trans('menu.'.$type.'_block_peoples')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
