            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">{{trans('menu.Admins')}}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
@section('content')
    ...
    <div class="card">
        ...
        {!! Form::open(['id'=>'form_data','url'=>HostUrl('admins/deleteMulti'),'method'=>'delete']) !!}
        {!! Form::hidden('method','delete') !!}
        {!! Form::hidden('deleted',$deleted) !!}
...
@section('dataTablesJs')
    ...
    <!-- sweet alert js -->
    <script type="text/javascript" src="{{ HostUrl('design\bower_components\sweetalert\js\sweetalert.min.js')}}"></script>
